      ...
      <div class="content flex-vertical flex-top flex-left">
         ...
         <div class="flex-horizontal">
            ...
            <div class="flex-vertical">
               ...
               <div class="form-section-header">Time Cards</div>
            
               <div id="time-card-table" style="margin-bottom: 30px"></div>
               
               <div class="form-section-header">Materials</div>
               
               <div id="heat-table"></div>

...
function getShipmentTicketId()
{
   $shipmentTicketId = Shipment::UNKNOWN_SHIPMENT_ID;
   
   $params = getParams();
   
   if ($params->keyExists("shipmentTicketId"))
   {
      $shipmentTicketId = $params->getInt("shipmentTicketId");
   }
   
   return ($shipmentTicketId);
}

function getShipmentTicket()
{
   $ticket = null;
   
   $shipmentTicketId = getShipmentTicketId();
   
   if ($shipmentTicketId != Shipment::UNKNOWN_SHIPMENT_ID)
   {
      $ticket = new ShipmentTicket($shipmentTicketId);
   }
...
<head>
   ...
   <script src="/shipment/shipmentTicket.js"></script>
...
<body class="flex-vertical flex-top flex-left">
   ...
   <form id="input-form" action="" method="POST">
      <input type="hidden" name="request" value="print_ticket">
      <input type="hidden" name="shipmentTicketId" value="<?php echo getShipmentTicketId(); ?>">
   </form>
   ...
   <div class="main flex-horizontal flex-top flex-left">
      ...
      <div class="content flex-vertical flex-top flex-left">
         ...
         <div class="flex-horizontal flex-v-center flex-h-center">
            <div class="heading">Print Shipment Tickets</div>&nbsp;&nbsp;
         ...
         <div class="flex-horizontal flex-v-center">
           ...
           <div style="margin-right: 50px;">
              <img id="ticket-image" src="" alt="shipment ticket"/>
           </div>
   ...
   <script>
      ...
      menu.setMenuItemSelected(<?php echo AppPage::SHIPMENT ?>); 
      
      preserveSession();

      function printTicket()
      {
         submitForm("input-form", "/app/page/shipment", function(response) {
      ...
      document.getElementById("print-button").onclick = printTicket;
      document.getElementById("help-icon").onclick = function(){document.getElementById("description").classList.toggle('shown');};
      
      dymo.label.framework.init(function() {
         var label = new ShipmentTicket(<?php echo getShipmentTicketId() ?>, "ticket-image");
      });
   </script>

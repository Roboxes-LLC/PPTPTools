   ...
   public static function getPages()
   {
      if (AppPage::$pages == null)
      {
         AppPage::$pages = array(
            ...
            AppPage::CORRECTIVE_ACTION =>   new AppPage(AppPage::CORRECTIVE_ACTION,   "Correct Actions",      null,                   Permission::VIEW_CORRECTIVE_ACTIONS,  "/correctiveAction/correctiveActions.php")
         );
      }

...
<head>
   ...
   <script src="/prospiraDoc/prospiraLabel.js"></script>
...
<body class="flex-vertical flex-top flex-left">
   ...
   <form id="input-form" action="" method="POST">
      <input type="hidden" name="request" value="print_label">
      <input type="hidden" name="docId" value="<?php echo getProspiraDocId(); ?>">
   </form>
   ...
   <div class="main flex-horizontal flex-top flex-left">
      ...
      <div class="content flex-vertical flex-top flex-left">
         ...
         <div class="flex-horizontal flex-v-center flex-h-center">
            <div class="heading">Print Prospira Labels</div>&nbsp;&nbsp;
         ...
         <div class="flex-horizontal flex-v-center">
           ...
           <div style="margin-right: 50px;">
              <img id="label-image" src="" alt="prospira label"/>
           </div>
   ...
   <script>
      ...
      menu.setMenuItemSelected(<?php echo AppPage::PROSPIRA_DOC ?>); 
      
      preserveSession();

      function printTicket()
      {
         submitForm("input-form", "/app/page/prospiraDoc", function(response) {
      ...
      dymo.label.framework.init(function() {
         let label = new ProspiraLabel(<?php echo getProspiraDocId() ?>, "label-image");
      });
   </script>

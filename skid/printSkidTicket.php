...
function getSkidId()
{
   ...
   {
      $materialTicketId = $params->getInt("skidId");
   }
...
<body class="flex-vertical flex-top flex-left">
   ...
   <form id="input-form" action="" method="POST">
      <input type="hidden" name="skidId" value="<?php echo getSkidId(); ?>">
   </form>
   ...
   <div class="main flex-horizontal flex-top flex-left">
      ...
      <?php Menu::render(Activity::SKID); ?>
      
      <div class="content flex-vertical flex-top flex-left">
      
         <div class="flex-horizontal flex-v-center flex-h-center">
            <div class="heading">Print Skid Tickets</div>&nbsp;&nbsp;
         ...
         <div class="flex-horizontal flex-v-center">
           ...
           <div style="margin-right: 50px;">
              <img id="skid-ticket-image" src="" alt="skid ticket"/>
           </div>
   ...
   <script>
      ...
      function printSkidTicket()
      {
         ...
         // Set up our request
         requestUrl = "/app/page/skid/?request=print_skid_ticket"
      ...
      document.getElementById("print-button").onclick = printSkidTicket;
      document.getElementById("help-icon").onclick = function(){document.getElementById("description").classList.toggle('shown');};
      document.getElementById("menu-button").onclick = function(){document.getElementById("menu").classList.toggle('shown');};
      
      dymo.label.framework.init(function() {
         var label = new MaterialTicket(<?php echo getSkidId() ?>, "material-ticket-image");
      });
   </script>
